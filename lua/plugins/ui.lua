      ...
      spec = {
        {
          ...
          { "<Space>?<Space>", function() require('which-key').show({ global = false }) end, desc = 'Buffer Local Keymaps (which-key)' },
          ...
          { "<Space>PP", function() require("lazy").sync() end, desc = "Update" },
          { "<Space>Pc", function() require("lazy").clean() end, desc = "Clean" },
          { "<Space>Pi", function() require("lazy").install() end, desc = "Install" },
          ...
          { "<Space>dd", "<cmd>lua vim.diagnostic.open_float()<CR>", desc = "Show diagnostics in floating window" },
          { "<Space>dl", "<cmd>Telescope diagnostics<CR>", desc = "[Telescope] Show diagnostics" },
          { "<Space>dn", "<cmd>lua vim.diagnostic.goto_next({ severity = { min = vim.diagnostic.severity.ERROR }, wrap = false })<CR>", desc = "Next" },
          ...
          { "<Space>sb", "<cmd>Telescope current_buffer_fuzzy_find<CR>", desc = "[Telescope] Current buffer lines" },
          { "<Space>sg", "<cmd>Telescope live_grep<CR>", desc = "[Telescope] Live grep" },
          { "<Space>ss", "<cmd>Telescope lsp_document_symbols<CR>", desc = "[Telescope] LSP document symbols" },
          ...
          { "<Space>td", function() vim.diagnostic.enable(not vim.diagnostic.is_enabled()) end, desc = "Diagnostics" },
        ...
        {
          mode = { "x" },
          { "<Space>S", "<cmd>split<CR><ESC><C-w>jgv:YodeCreateSeditorReplace<CR>", desc = "Focus on selection (horizontal split, below)" },
          { "<Space>V", "<cmd>vsplit<CR><ESC><C-w>lgv:YodeCreateSeditorReplace<CR>", desc = "Focus on selection (vertical split, right)" },
          { "<Space>a", "<Plug>(EasyAlign)", desc = "EasyAlign" },
          ...
          { "<Space>s", "<cmd>split<CR>:YodeCreateSeditorReplace<CR>", desc = "Focus on selection (horizontal split, above)" },
          { "<Space>v", "<cmd>vsplit<CR>:YodeCreateSeditorReplace<CR>", desc = "Focus on selection (vertical split, left)" },
        },
      },
    },
  },
