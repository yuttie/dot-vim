      ...
      spec = {
        {
          ...
          { "<Space>c", require('Comment.api').call('toggle.linewise', 'g@'), desc = "Toggle line-wise", expr = true, replace_keycodes = false },
        ...
        },
        {
          ...
          { "<Space>a", "<Plug>(EasyAlign)", desc = "EasyAlign" },
          { "<Space>c", '<ESC><CMD>lua require("Comment.api").toggle.linewise(vim.fn.visualmode())<CR>', desc = "Toggle line-wise" },
          { "<Space>g", group = "git" },
          { "<Space>gr", "<cmd>Gitsigns reset_hunk<CR>", desc = "Reset hunk", remap = false },
          { "<Space>gs", "<cmd>Gitsigns stage_hunk<CR>", desc = "Stage hunk", remap = false },
          { "<Space>h", group = "highlight" },
